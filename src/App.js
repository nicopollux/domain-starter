...
// Constants
const TWITTER_HANDLE = 'nicopollux';
const TWITTER_LINK = `https://twitter.com/${TWITTER_HANDLE}`;
// Add the domain you will be minting
const tld = '.pollux';
const CONTRACT_ADDRESS = '0x9B32cF3A8820501C68a9d2A00EeCfd6F04C185a7';
	...
	return (
		<div className="App">
			...
			<div className="header-container">
				<header>
					<div className="left">
						<p className="title"> Pollux Name Service</p>
						<p className="subtitle">Greatest Name Services</p>
					</div>
